...
async function main() {
  ...
  const portfolio = [
    { id: "pf00000000000000000001", title: "Baneshwor Commercial Complex Supply", slug: "baneshwor-commercial-complex", description: "Complete building material supply for a 5-story commercial complex in Baneshwor, Kathmandu. Supplied cement, steel reinforcement, electrical fittings, and sanitary ware over a 12-month period.", category: "Construction Supply", client: "Modern Builders Pvt. Ltd.", completionDate: "2025-11-15" },
    { id: "pf00000000000000000002", title: "eSewa & Khalti Integration for Dangol Traders", slug: "esewa-khalti-dangol-traders", description: "Full e-commerce platform development with Nepal payment gateway integration (eSewa, Khalti, COD) for Dangol Traders, a Baneshwor-based retail business. Includes inventory management and delivery tracking.", category: "E-commerce", client: "Dangol Traders", completionDate: "2026-03-20" },
    { id: "pf00000000000000000003", title: "Kathmandu Valley Logistics Overhaul", slug: "kathmandu-logistics-overhaul", description: "Designed and implemented a new logistics routing system for Joshi & Sons Hardware, reducing delivery times by 50% across 12 retail locations in the Kathmandu Valley.", category: "Logistics", client: "Joshi & Sons Hardware", completionDate: "2025-08-10" },
    { id: "pf00000000000000000004", title: "Hotel Bouddha Renovation Project", slug: "hotel-bouddha-renovation", description: "Full project management consultancy for the renovation of Bouddha Boutique Hotel. Scope included structural assessment, contractor coordination, material sourcing, and quality assurance.", category: "Consultancy", client: "Bouddha Boutique Hotel", completionDate: "2026-01-25" },
    { id: "pf00000000000000000005", title: "Newa Enterprises Digital Presence", slug: "newa-enterprises-website", description: "Designed and developed the complete digital presence for Newa Enterprises including this corporate website, social media profiles, and digital marketing strategy.", category: "Digital Services", client: "Newa Enterprises", completionDate: "2026-07-01" },
  ];
  for (const p of portfolio) {
    await query(
      `INSERT INTO "PortfolioItem" ("id","title","slug","description","category","client","completionDate","isActive","updatedAt") VALUES ($1,$2,$3,$4,$5,$6,$7::date,true,NOW()) ON CONFLICT ("slug") DO UPDATE SET "title"=EXCLUDED."title","description"=EXCLUDED."description","category"=EXCLUDED."category"`,
      [p.id, p.title, p.slug, p.description, p.category, p.client, p.completionDate]
    );
  }
